...
const AviatorGame = () => {
  ...
  const cashOut = () => {
    ...
    cancelAnimationFrame(requestRef.current);
    setIsFlying(false);
    alert(`Jackpot! Aapne ₹${(bet * multiplier).toFixed(2)} Cash out kiye! 143!`);
  };
    ...
    <>
      <style>{`
        .aviator-body {
          ...
          overflow: hidden; /* Bahar jane se rokega */
        }
        .header-title {
          color: #ffeb3b; 
          margin: 5px 0; 
        ...
        .game-area {
          ...
          width: 100%;
          max-width: 600px;
          height: 35vh; /* Kam kiya height mobile ke liye */
          background: #141518;
          border-radius: 15px;
          border: 1px solid #2b2d31;
          overflow: hidden;
          flex-shrink: 0; /* Iska size fix rahega */
        }
        .multiplier-val {
          position: absolute;
          top: 50%;
        ...
        .bet-box {
          ...
          border-radius: 20px;
          box-sizing: border-box;
          flex-shrink: 0; /* Neeche dabne se rokega */
        }
        .input-row {
          display: flex;
          background: #000;
      ...
      <div className="aviator-body">
        ...
        <div className="bet-box">
          <div className="input-row">
            <button onClick={() => setBet(Math.max(10, bet - 50))}>-</button>
